    ...
    <div className="flex flex-col min-h-[calc(100vh-120px)] bg-amber-50 p-4">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <p className="text-slate-600 text-center mb-8 max-w-sm">
          There are no available deliveries at the moment. Check back soon or
        ...
        <Link href="/deliveries">
          <Button
            variant="outline"
            className="border-slate-800 text-slate-800 hover:bg-slate-100 font-bold py-3 px-8 rounded"
          >
            View My Deliveries
          </Button>
        </Link>
