  ...
  async (req: Request, res: Response) => {
    try {
      ...
      if (data.assignedDriver !== undefined)
        updatePayload.assignedDriver = data.assignedDriver;
      if (data.assignedCenterId !== undefined)
        updatePayload.assignedCenterId = data.assignedCenterId;
      if (data.location !== undefined) updatePayload.location = data.location;
      if (data.activityType !== undefined)
        updatePayload.activityType = data.activityType;
      if (data.orderTime !== undefined)
        updatePayload.orderTime = new Date(data.orderTime);
